...
export async function updateSession(request: NextRequest) {
  ...
  // ── Обычная CRM клуба ──
  const publicPaths = ["/", "/about", "/contacts", "/docs", "/blog", "/terms", "/privacy", "/robots.txt", "/sitemap.xml", "/login", "/register", "/forgot-password", "/reset-password", "/auth", "/tg", "/api/auth", "/api/telegram", "/api/integrations", "/api/invite-track", "/api/pay", "/api/cron", "/api/broadcasts", "/accept-invite"]

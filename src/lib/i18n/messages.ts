...
export const messages = {
  ru: {
    ...
    pricing: {
      ...
      planLabel: "Тариф",
      trialLabel: "Знакомство с FitCRM",
      bestChoice: "Оптимальный выбор",
      standardPitch: "Полный набор инструментов для растущего клуба и команды, которая работает на результат.",
      standardProof: "Клиенты, команда, филиалы и все интеграции — без необходимости докупать ключевые модули.",
      startFree: "Попробовать бесплатно",
      chooseStandard: "Выбрать Стандарт",
      choosePlan: (name: string) => `Выбрать ${name}`,
      noCard: "Карта не нужна",
      cancelAnytime: "Можно отменить в любой момент",
      planNames: { trial: "Пробный", starter: "Старт", standard: "Стандарт", business: "Бизнес" },
    },
    faq: {
      title: "FAQ",
      items: [
  ...
  en: {
    ...
    pricing: {
      ...
      planLabel: "Plan",
      trialLabel: "Meet FitCRM",
      bestChoice: "Best value",
      standardPitch: "The complete toolkit for a growing club and a team focused on measurable results.",
      standardProof: "Clients, team, branches and every integration without paying extra for essential modules.",
      startFree: "Try for free",
      chooseStandard: "Choose Standard",
      choosePlan: (name: string) => `Choose ${name}`,
      noCard: "No credit card required",
      cancelAnytime: "Cancel anytime",
      planNames: { trial: "Trial", starter: "Starter", standard: "Standard", business: "Business" },
    },
    faq: {
      title: "FAQ",
      items: [
  ...
  uz: {
    ...
    pricing: {
      ...
      planLabel: "Tarif",
      trialLabel: "FitCRM bilan tanishuv",
      bestChoice: "Eng maqbul tanlov",
      standardPitch: "O‘sayotgan klub va natijaga ishlaydigan jamoa uchun to‘liq vositalar to‘plami.",
      standardProof: "Mijozlar, jamoa, filiallar va barcha integratsiyalar — asosiy modullar uchun qo‘shimcha to‘lovsiz.",
      startFree: "Bepul sinab ko‘rish",
      chooseStandard: "Standartni tanlash",
      choosePlan: (name: string) => `${name}ni tanlash`,
      noCard: "Karta talab qilinmaydi",
      cancelAnytime: "Istalgan payt bekor qilish mumkin",
      planNames: { trial: "Sinov", starter: "Boshlang‘ich", standard: "Standart", business: "Biznes" },
    },
    faq: {
      title: "FAQ",
      items: [

  ...
  ru: {
    ...
    growthRetention: {
      ...
      benefits: [
        ...
        { title: "Готовые действия", desc: "Команда получает приоритет, аудиторию и подходящий сценарий вместо сырой таблицы." },
  ...
  en: {
    ...
    growthRetention: {
      ...
      benefits: [
        ...
        { title: "Ready actions", desc: "Your team gets a priority, audience and playbook instead of another raw spreadsheet." },
  ...
  uz: {
    ...
    growthRetention: {
      ...
      benefits: [
        ...
        { title: "Tayyor harakatlar", desc: "Jamoa oddiy jadval o‘rniga ustuvorlik, auditoriya va mos ssenariyni oladi." },

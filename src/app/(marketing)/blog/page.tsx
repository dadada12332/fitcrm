...
export const metadata = { title: "Блог — Zalkins" }
...
const POSTS = [
  ...
  { tag: "Кейс", date: "Скоро", title: "Сеть из 6 залов на одной панели: опыт внедрения Zalkins", excerpt: "Как мультифилиальность помогает управлять сетью без хаоса в таблицах." },

...
import {
  ...
  Bot, Zap, MessageSquare, BarChart2, RefreshCw,
} from "lucide-react"
import {
...
function TelegramManage({ connected, botUsername, botFirstName, connectedAt, clientCount, tgSettings }: {
  connected: boolean
  botUsername: string
  botFirstName: string
...
export function IntegrationManage({ slug, label, color, connected, currentValue, clientCount, tgSettings, botUsername, botFirstName, connectedAt }: {
  slug: string; label: string; color: string
  connected: boolean; currentValue: string; clientCount: number
  tgSettings?: TelegramSettings

...
export function WarehouseSwitcher({ clubId, products, movements, stats, connectedProviders, canSell, canSupply, canWriteoff, canViewCost }: Props) {
  ...
  return version === "pos"
    ...
    : <InventoryClient clubId={clubId} products={products} movements={movements} stats={stats} canSupply={canSupply} canWriteoff={canWriteoff} canViewCost={canViewCost} versionControl={toggle} />
}

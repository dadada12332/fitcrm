...
const FEATURED = {
  quote: "Мы перешли с Excel на Zalkins за один вечер. Через неделю выручка стала прозрачной, а администраторы перестали тонуть в бумагах. Эффект был мгновенным.",
  name: "Азиз Каримов",

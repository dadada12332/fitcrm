...
- Branch: `main`.
- Последний commit: 5a34a27 · 2026-07-27T04:24:29+05:00 · fix: stop dashboard onboarding redirect loop.
...
читают тот же профиль. Глобальный переключатель RU/UZ/EN хранит язык на сотруднике; shell,
навигация и экран основных настроек локализованы, перевод длинного контента остальных модулей
продолжается инкрементально.

...
- В репозитории последовательные миграции `0001`–`0084` и отдельный timestamped index; `0082`–`0084` добавляют метод `turnstile`, service-only таблицы, атомарные RPC контроля доступа и привязку vendor-side external ID.

...
- В репозитории последовательные миграции `0001`–`0092` и отдельные timestamped миграции;
  `0087`–`0092` реализуют роли Platform, промокоды, рассылки, monitoring history,
  operational settings, ежедневные SaaS-метрики и покрывающие FK-индексы.

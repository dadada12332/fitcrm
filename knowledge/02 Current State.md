...
- В репозитории последовательные миграции `0001`–`0081` и отдельный timestamped index; `0080`–`0081` добавляют уникальность остатка товара и service-only атомарные операции поставки/списания.

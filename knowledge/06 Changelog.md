...
- В существующем разделе «Интеграции» появились Beta-коннекторы Sigur, ZKTeco и Hikvision: локальный FitCRM Bridge, привязка карт и браслетов, проверка допуска, журнал событий и симулятор без физического турникета.

# Zalkins Access Bridge

Локальный агент между Zalkins Cloud и уже установленной в клубе системой контроля доступа.
...
- постоянный исходящий HTTPS-доступ к Zalkins;
...
- online access request при недоступности Zalkins всегда получает отказ;

...
| 10.06.2026 | Схема БД (18 MVP-таблиц, RLS через staff, миграция supabase/migrations/0001_init.sql), онбординг клуба, CRUD ядра (клиенты, абонементы), дашборд на реальных данных |
